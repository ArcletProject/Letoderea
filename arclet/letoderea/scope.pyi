...
class Scope(Generic[TWrapper]):
    ...
    @overload
    def register(self, *, event: type | None = None, priority: int = 16, providers: TProviders | None = None, propagators: list[Propagator] | None = None, publisher: str | Publisher | None = None, once: bool = False, skip_req_missing: bool | None = None) -> TWrapper: ...
