...
class _step_iter(Generic[R, D]):
    ...
    @overload
    def __anext__(self: "_step_iter[CoroutineType[Any, Any, R1], None] | _step_iter[Awaitable[R1], None]") -> Awaitable[R1 | None]: ...

    @overload
    def __anext__(self: "_step_iter[CoroutineType[Any, Any, R1], D1] | _step_iter[Awaitable[R1], D1]") -> Awaitable[R1 | D1]: ...

    @overload
    def __anext__(self: "_step_iter[R1, None]") -> Awaitable[R1 | None]: ...

    @overload
    def __anext__(self: "_step_iter[R1, D1]") -> Awaitable[R1 | D1]: ...
...
class StepOut(Generic[R]):
    ...
    @overload
    async def wait(self: "StepOut[CoroutineType[Any, Any, R1]] | StepOut[Awaitable[R1]]", *, timeout: float = 120) -> R1 | None: ...

    @overload
    async def wait(self: "StepOut[CoroutineType[Any, Any, R1]] | StepOut[Awaitable[R1]]", *, default: R1 | D, timeout: float = 120) -> R1 | D: ...

    @overload
    async def wait(self: "StepOut[R1]", *, timeout: float = 120) -> R1 | None: ...

    @overload
    async def wait(self: "StepOut[R1]", *, default: R1 | D, timeout: float = 120) -> R1 | D: ...
